...
At 30% efficiency the compressor draws more power than it would add. Hence, the optimum solution is to run the system with no compression.
</p>
<p><img src="/assets/images/pem_2.png" style="width: 70%; float: left; padding-right: 20px">
...
<p><img src="/assets/images/pem_3.png" style="width: 70%; float: left; padding-right: 20px">

The power curve shifts upward with increase in efficiency because of higher voltage.</p>

<p><img src="/assets/images/pem_4.png" style="width: 70%; float: left; padding-right: 20px">
